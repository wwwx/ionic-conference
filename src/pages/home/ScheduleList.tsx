        ...
        <div className="item mb-3 border-bottom pb-3 fadeInUp" style={props.style}>
            <div className="top d-flex align-items-center mb-1">
                <IonButton color={options.color} size="small" className="m-0">
                    <IonAvatar>
                        <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAY0lEQVQ4T+2TUQ6AMAhD25u5kxlP5m5Wg6kfJptuzi8jv9AXKEAMBmt6SROA2fmFZC7V3gFWi9JHAJKOkUAyxXhdHhgQ5gZg174HkCQ7nqM9r/G0hcsOfgAw7MHTp6zeQStwA8/igxEfLWE4AAAAAElFTkSuQmCC" alt="" />
                    </IonAvatar>
...
const ScheduleList: React.FC<ScheduleListProps> = (props) => {
    ...
    return (
        ...
        {listData.map(
            (_: ScheduleParams, i: number) => <ScheduleItem data={_} style={{
